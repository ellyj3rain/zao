...
| Current version | `0.1.1.5-pre-alpha` |
| Closed chronology | `A1-A7` |
| Next batch | `A8` |
...
`A8` is the next batch. Its content determines its tier after it
exists:

| If A8 is | Result |
|---|---|
| patch or hotfix | `0.1.1.6-pre-alpha` |
